...
HISTOGRAM_SITE_CONNECTION_TIME = prometheus_client.Histogram('crawler_site_connection_time',
                                                             'How much time it took for crawler to get page')
HISTOGRAM_PAGE_PARSE_TIME = prometheus_client.Histogram('crawler_page_parse_time',
                                                        'How much time it took to parse a page')
...
if __name__ == "__main__":
    ...
    publish_url(getenv('URL', ''))
    channel.basic_consume(queue=mqqueue, on_message_callback=callback)
